...
import { ThumbnailUploadModal } from "../components/studio-sidebar/thumbnail-upload-modal";
import { ThumbnailGenerateModal } from "../components/studio-sidebar/thumbnail-generate-modal";
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
                              type="button"
                              size="icon"
                              className="hover:bg-black/50 bg-black/50 absolute top-1 right-1 rounded-full opacity-100 md:opacity-0 group-hover:opacity-100 duration-300 size-7"
                            >
